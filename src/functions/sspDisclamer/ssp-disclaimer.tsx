            ...
            <div className="disclaimerContainer">
                <div className="disclaimerBox">
                    ...
                    <div className="disclaimerContent">
                        ...
                        <p>If you encounter any bugs or unexpected behaviour, you are welcome to report them either in the <strong><a href='' target='_blank'>SimRail Forum Thread</a></strong> or on the GitHub repository. Your feedback helps improve this tool.</p>
                    </div>
