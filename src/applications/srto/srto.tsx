...
const FORUM_LINK = 'https://forum.simrail.eu/topic/12629-simrail-track-overview-srto/'
const GITHUB_REPO_LINK = 'https://github.com/TheTrueVirus/simrail-tools-html'
const GITHUB_PAGE_LINK = 'https://thetruevirus.github.io/simrail-tools-html/'
